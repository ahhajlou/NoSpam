...
import com.nospam.nospam.core.telephony.service.HeadlessSmsSendService
...
class TelephonyMapperTest {
    ...
    @Test fun `toConversation groups by latest message`() {
        val thread = com.nospam.nospam.core.model.ThreadId(5L)
        val messages = listOf(
            com.nospam.nospam.core.model.Message(
                com.nospam.nospam.core.model.MessageId(1), thread,
                "+1555", "older", 1000L,
                com.nospam.nospam.core.model.MessageType.INBOX, read = true,
            ),
            com.nospam.nospam.core.model.Message(
                com.nospam.nospam.core.model.MessageId(2), thread,
                "+1555", "latest unread", 2000L,
                com.nospam.nospam.core.model.MessageType.INBOX, read = false,
            ),
        )
